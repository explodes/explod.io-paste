...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gym.email_address'
        db.add_column(u'xfit_gym', 'email_address',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gym.phone_number'
        db.add_column(u'xfit_gym', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gym.website'
        db.add_column(u'xfit_gym', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gym.email_address'
        db.delete_column(u'xfit_gym', 'email_address')

        # Deleting field 'Gym.phone_number'
        db.delete_column(u'xfit_gym', 'phone_number')

        # Deleting field 'Gym.website'
        db.delete_column(u'xfit_gym', 'website')
