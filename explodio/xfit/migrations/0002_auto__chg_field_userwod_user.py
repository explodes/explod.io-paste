...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserWOD.user'
        db.alter_column(u'xfit_userwod', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))

    def backwards(self, orm):

        # Changing field 'UserWOD.user'
        db.alter_column(u'xfit_userwod', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
